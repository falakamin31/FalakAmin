...
export const projects = [
  ...
  },
  {
    ...
    subtitle: "Next.js · Web3 Marketplace",
    description:
      "SEO-optimized marketplace interface built with Next.js, integrating third-party APIs with request optimization and caching that reduced API calls by ~35% and improved response time by ~25%.",
    stack: ["Next.js", "React", "Google Maps API", "Vercel"],
